...
import { ANIMATION_DURATION, AUTO_SLIDE_INTERVAL } from './constants.js';
...
export function setupTestimonials(container) {
  ...
  function renderTestimonial(index) {
    ...
    container.innerHTML = `
      <div class="testimonial-card" role="region" aria-label="Testimonial ${index + 1} of ${testimonials.length}">
